...
WORDS = """
家人: 爸爸=ㄅㄚˋ ˙ㄅㄚ 媽媽=ㄇㄚ ˙ㄇㄚ 哥哥=ㄍㄜ ˙ㄍㄜ 姐姐=ㄐㄧㄝˇ ˙ㄐㄧㄝ 弟弟=ㄉㄧˋ ˙ㄉㄧ 妹妹=ㄇㄟˋ ˙ㄇㄟ 爺爺=ㄧㄝˊ ˙ㄧㄝ 奶奶=ㄋㄞˇ ˙ㄋㄞ 阿姨=ㄚ ㄧˊ 叔叔=ㄕㄨˊ ˙ㄕㄨ
...
身體: 眼睛=ㄧㄢˇ ˙ㄐㄧㄥ 鼻子=ㄅㄧˊ ˙ㄗ 耳朵=ㄦˇ ˙ㄉㄨㄛ 嘴巴=ㄗㄨㄟˇ ˙ㄅㄚ 頭髮=ㄊㄡˊ ˙ㄈㄚ 肚子=ㄉㄨˋ ˙ㄗ 手指=ㄕㄡˇ ㄓˇ 腳丫=ㄐㄧㄠˇ ㄧㄚ
顏色: 紅色=ㄏㄨㄥˊ ㄙㄜˋ 黃色=ㄏㄨㄤˊ ㄙㄜˋ 藍色=ㄌㄢˊ ㄙㄜˋ 綠色=ㄌㄩˋ ㄙㄜˋ 白色=ㄅㄞˊ ㄙㄜˋ 黑色=ㄏㄟ ㄙㄜˋ 粉紅=ㄈㄣˇ ㄏㄨㄥˊ 紫色=ㄗˇ ㄙㄜˋ
生活: 吃飯=ㄔ ㄈㄢˋ 睡覺=ㄕㄨㄟˋ ㄐㄧㄠˋ 洗澡=ㄒㄧˇ ㄗㄠˇ 刷牙=ㄕㄨㄚ ㄧㄚˊ 上學=ㄕㄤˋ ㄒㄩㄝˊ 玩具=ㄨㄢˊ ㄐㄩˋ 書包=ㄕㄨ ㄅㄠ 學校=ㄒㄩㄝˊ ㄒㄧㄠˋ 老師=ㄌㄠˇ ㄕ 朋友=ㄆㄥˊ ˙ㄧㄡ 太陽=ㄊㄞˋ ˙ㄧㄤ 月亮=ㄩㄝˋ ˙ㄌㄧㄤ 下雨=ㄒㄧㄚˋ ㄩˇ 星星=ㄒㄧㄥ ˙ㄒㄧㄥ
...
def main():
    ...
    for name, witems in wgroups:
        out.append(f'  {{ name: {js(name)}, items: [{", ".join(js(z) for t, z in witems)}] }},')
    out.append(']')
    out.append('')
    ...
    out.append('}')
    out.append('')
    allw = [z for name, witems in wgroups for t, z in witems]
