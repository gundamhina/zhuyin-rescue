...
答對賺骨頭（第一次就對 2 根、重試才對 1 根、玩完一局送 3 根、翻牌每對 1 根），首頁「商店」用骨頭買狗狗配件（九件，分頭上、臉上、脖子），買了戴在她的狗狗身上。配件在 `src/art.js` 的 `ACCESSORIES`，是畫在狗狗 260×300 框裡的 SVG；商店畫面在 `src/shop.js`。家長區可以加減骨頭。
