...
GROUPS = [
    ...
    ('cards', '首頁七張卡片', '首頁一打開就看到，現在是向量畫的卡片。',
     '上傳 img/home.png 當畫風參考，說「用這張圖的畫風」。'),
    ('bgs', '三張遊戲背景', '現在除了釣魚，每個遊戲都借用首頁的草原。',
     '上傳 img/home.png 當畫風參考。手機直拿只看得到中間，所以中間要安靜。'),
    ('words', '74 個詞的圖', '連連看和填空的圖，現在是表情符號。一次生九張，處理工具會自動切開。',
     '上傳 img/home.png 當畫風參考。生出來請確認九個東西的順序跟下面列的一樣。'),
]
...
def write_html(items, out_dir):
    data = {
        ...
        'refs': {
            ...
            'img/home.png': thumb('img/home.png', 360, 'JPEG'),
        },
    }
